...
@Repository
public class RoleDaoImp implements UserDetailsService {
    ...
    public void setUserRoles(Long user_id, Set<Role> newRoles) {
        try {
            User user = roleDao.getOne(user_id);
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        Optional<User> userOptional = roleDao.findByEmail(email);
    ...
    public User getInfo(UserDetails currentUserDetails) {
        ...
        Optional<User> userOptional = roleDao.findByEmail(loggedInUserEmail);
